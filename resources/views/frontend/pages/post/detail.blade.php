...
@push('style')
  ...
  <link rel="stylesheet" href="{{ asset('themes/frontend/watches/about-us.css.css') }}" />
@endpush
                      ...
                      <div class="grid-inner row align-items-center gutter-20">
                        <div class="col-4 col-xl-5">
                          <div class="entry-image">
                            <a href="{{ $alias }}"><img style="height: 180px" src="{{ $image }}" alt="Blog Single"></a>
                          </div>
                        </div>
