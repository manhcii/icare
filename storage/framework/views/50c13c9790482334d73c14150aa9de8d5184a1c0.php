...
<?php $__env->startSection('content'); ?>
  <section class="bg-gradient " style="background-image: url('<?php echo e($image_background); ?>'); background-size: cover;" id="page-title">
    <div class="container clearfix text-center">
      <h1 class=""><?php echo e($taxonomy_title); ?></h1>
      <span class="elipsis1"><?php echo e($title); ?></span>
    </div>
  </section>
  <section id="content">
          ...
          <div class="product">
            <div class="row gutter-40">
                    ...
                    <div class="flexslider">
                      <div class="slider-wrap" data-lightbox="gallery">
                        <div class="slide"data-thumb="<?php echo e($image); ?>">
                          <a href="<?php echo e($image); ?>"data-lightbox="gallery-item">
                            <img src="<?php echo e($image); ?>"alt="Pink Printed Dress"/>
                          </a>
                        </div>
                        <?php if(isset($detail->json_params->gallery_image)): ?>
                            <?php $__currentLoopData = $detail->json_params->gallery_image; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                              <div class="slide"data-thumb="<?php echo e($value); ?>">
                                <a href="<?php echo e($value); ?>"data-lightbox="gallery-item">
              ...
              <div class="col-md-6 product-desc">
                <!-- Product Name -->
                <h4 class="display-6"><?php echo e($title); ?></h4>
                <div
                ...
                >
                  ...
                  <button type="button" data-id="<?php echo e($detail->id); ?>" data-quantity="1" class="add-to-cart bg-gradient button m-0 add-to-cart">
                      ...
                      <form class="row mb-0" action="<?php echo e(route('frontend.review.store.product')); ?>" method="post">
                        ...
                        <div class="col-6 mb-3">
                          ...
                          <div class="input-group">
                            ...
                            <input required type="text"id="template_reviewform_name"name="template_reviewform_name"value="<?php echo e(old('template_reviewform_name')); ?>"class="form-control required"/>
                          </div>
                        </div>
                        <div class="col-6 mb-3">
                          ...
                          <div class="input-group">
                            ...
                            <input required type="email"id="template_reviewform_email"name="template_reviewform_email"value="<?php echo e(old('template_reviewform_email')); ?>"class="required email form-control"/>
                          </div>
                        </div>
                ...
                <div class="tabs clearfix my-5 mb-0" id="tab-1">
                  <ul class="tab-nav clearfix">
                    ...
                    <li>
                      <a href="#tabs-3"
                        ><span class="d-none d-md-inline-block">
                          Reviews (<?php echo e(count($review)); ?>)</span
                        ></a
                      >
                    </li>
                  </ul>
                                    ...
                                    <div class="comment-content clearfix">
                                      <div style="font-weight: bold;" class="comment-author ">
                                        <?php echo e($review->name); ?><span
                                          ><a><?php echo e($review->created_at); ?></a></span>
                                      </div>
                                      <p>
                  ...
                  <div class="product">
                    <div class="product-image">
                      ...
                      <div class="bg-overlay">
                        ...
                        >
                          <a style="border-radius: 50% !important;" href="javascript:void(0)" title="<?php echo app('translator')->get('Add to cart'); ?>" data-id="<?php echo e($item->id); ?>" data-quantity="1" class="add-to-cart btn me-2"
                    ...
                    <div class="product-desc center">
                      ...
                      <div class="product-price"><del><?php echo e(isset($price_old) && $price_old > 0 ? number_format($price_old, 0, ',', '.') . ' VNĐ' : ""); ?></del> <ins><?php echo e(isset($price) && $price > 0 ? number_format($price, 0, ',', '.') . ' VNĐ' : __('Contact')); ?></ins>
                      </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('frontend.layouts.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\capital\resources\views/frontend/pages/product/detail.blade.php ENDPATH**/ ?>