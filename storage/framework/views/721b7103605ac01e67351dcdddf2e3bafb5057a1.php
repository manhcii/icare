                    ...
                    <div>
                      <div class="counter mb-0 fw-normal font-body text-primary">
                        <span class="font-body" data-from="1" data-to="8" data-refresh-interval="10"
                          data-speed="2000"><?php echo e($web_information->information->year ?? ''); ?></span>+
                      </div>
                      <h5 class="mt-2 text-muted font-body ls0"><?php echo app('translator')->get('năm'); ?></h5>
                    </div>
                  </div>
                </div>
                    ...
                    <div>
                      <div class="counter mb-0 fw-normal font-body text-info">
                        <span class="font-body" data-from="1" data-to="50" data-refresh-interval="200"
                          data-speed="23000"><?php echo e($web_information->information->project ?? ''); ?></span>+
                      </div>
                      <h5 class="mt-2 text-muted font-body ls0">
                        <?php echo app('translator')->get('Dự án'); ?>
                      </h5>
                    </div>
                  </div>
                  <div class="circle-inner">
                    <div>
                      <div class="counter mb-0 fw-normal font-body text-warning">
                        <span class="font-body" data-from="1" data-to="100" data-refresh-interval="100"
                          data-speed="2400"><?php echo e($web_information->information->adviser ?? ''); ?></span>+
                      </div>
                      <h5 class="mt-2 text-muted font-body ls0">
                    ...
                    <div>
                      <div class="counter mb-0 fw-normal font-body color">
                        <span class="font-body" data-from="1" data-to="30" data-refresh-interval="100"
                          data-speed="2400"><?php echo e($web_information->information->professer ?? ''); ?></span>+
                      </div>
                      <h5 class="mt-2 text-muted font-body ls0">
                        <?php echo app('translator')->get('chuyên gia'); ?>
                      </h5>
                    </div>
                  </div>
                </div>
...
<?php endif; ?>  <?php /**PATH E:\xampp\htdocs\Icarecode\resources\views/frontend/blocks/custom/styles/about_development.blade.php ENDPATH**/ ?>