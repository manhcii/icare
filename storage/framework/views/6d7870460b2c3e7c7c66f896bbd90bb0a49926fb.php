    ...
    <div class="container clearfix">
      <div class="form-widget">
        ...
        <div class="row shadow bg-light border">
          <div class="col-lg-5 dark" style="background: linear-gradient(rgba(0,0,0,.8), rgba(0,0,0,.2)), url('<?php echo e($image); ?>') center center / cover; min-height: 400px;">
          </div>
...
<?php endif; ?><?php /**PATH E:\xampp\htdocs\Icarecode\resources\views/frontend/blocks/form/styles/booking.blade.php ENDPATH**/ ?>